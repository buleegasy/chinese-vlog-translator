...
export async function POST(req: Request) {
  ...
  try {
    ...
    const generationPromise = (async () => {
      ...
      // ⚡ Bolt Optimization: Eagerly cancel the network request on timeout
      // by passing the AbortSignal to getCloudflareEmbedding instead of just
      // rejecting a wrapping promise. Prevents zombie requests in the background.
