...
**③ 词汇直译降维（最有趣的特征）**
把中文雅词/专有词换成更简单甚至错误的描述，像是查字典查到了第一个义项：
- 雾霾 → 天气很脏
- 维修工 → 水桶的人
- 无脑片 → 很笨的电影
- 摄影器材进水 → 摄影宝淹没了
...
- 「我感觉了创伤后应激障碍」
- 「我觉得我又存在主义危机」
注意：只有原文有明显的自嘲、崩溃、苦难才用，普通句子严禁捏造。
...
- 不要每条特征都拼命往上堆，真实语料有些句子改动很大，有些几乎没变，保持自然节奏。
- 不要输出任何解释或Markdown格式。
